	...
	const DATA_TREE = [
		{
			...
			menuContext: [
				{ id: 'Option1', icon: 'any', label: 'Option1' },
				{ id: 'Option2', icon: 'any', label: 'Option2' }
			],
			subMenus: [
				{ title: 'sub-option', items: [ { title: 'item  1' }, { title: 'item 2' } ] },
							...
							children: [
								{
									...
									icon: {
										...
										style: { color: '#ef7622', fontSize: '14px', marginLeft: '10px' }
									},
									menuContext: [
										{ id: 'Option1', icon: 'any', label: 'Option1' },
										{
...
const DATA = [
	{
		...
		yellow: 17,
		gray: 129,
		labelStyle: { color: '#EF7622', fontWeight: '700', fontSize: '14px' },
		children: [
			{
				name: 'Baker',
				labelStyle: { color: 'black', fontWeight: '600', fontSize: '12px' },
				type: 'customer',
				toggled: false,
				loading: true,
				withIcon: true,
				...
				children: [
					{
						name: 'Baker entity',
						type: 'entity',
						labelStyle: { color: '#333', fontWeight: '600', marginLeft: '10px', fontSize: '12px' },
						icon: { className: 'icon-tree-warning' },
						toggled: false,
						loading: true,
						withIcon: true,
						...
						children: [
							{
								...
								type: 'site',
								labelStyle: { color: '#333', fontWeight: '500', marginLeft: '15px', fontSize: '12px' },
								icon: { className: 'icon-tree-warning' },
								toggled: false,
								loading: true,
								withIcon: true,
								...
								withCircles: false,
								menuContext: [ { id: 'Satellite', icon: 'any', label: 'Satellite' } ],
								children: [
									{
										id: '5c61d62a9c70f30c1758a878',
										type: 'device',
										name: 'iDirect-X3-177655',
										icon: { className: 'icon-work' },
										toggled: false,
										withCircles: false,
										menuContext: [ { id: 'Custom Mark', icon: 'any', label: 'Custom Mark' } ],
										subMenus: [
											{
												title: 'Tracking',
												items: [ { title: 'Active' }, { title: 'Configuration' } ],
												children: []
											}
										]
									}
								...
								children: [
									{
										...
										icon: { className: 'icon-unreachable' },
										toggled: false,
										withCircles: false,
										menuContext: [ { id: 'Custom Mark', icon: 'any', label: 'Custom Mark' } ],
										subMenus: [
